function plot_dcf_curve_min(plot_obj,plot_args,legend_string)
% Plots the minimum DCF curve for the current system (see
% set_system).
% Inputs:
...
plot_obj.plot_dcf_curve(plot_obj.minDCF,plot_args,legend_string);
end    
