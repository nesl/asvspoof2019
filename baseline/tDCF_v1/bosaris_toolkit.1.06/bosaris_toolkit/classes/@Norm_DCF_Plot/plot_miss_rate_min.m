function plot_miss_rate_min(plot_obj,plot_args,legend_string)
% Plots the contribution of the misses to the minimum dcf curve.
% Inputs:
...
plot_obj.plot_miss_rate(plot_obj.minPmiss,plot_args,legend_string);
end
