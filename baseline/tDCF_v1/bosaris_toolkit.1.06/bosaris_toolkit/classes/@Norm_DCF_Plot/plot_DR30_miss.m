...
% Plots the point on the minDCF curve at which the number of misses
% falls below 30 (see Doddington's Rule of 30).
% Inputs:
...
lh = plot(plot_obj.plo(plot_obj.dr30Miss),plot_obj.minDCF(plot_obj.dr30Miss),plot_args{:});
