function plot_fa_rate_min(plot_obj,plot_args,legend_string)
% Plots the contribution of the false alarms to the minimum dcf curve.
% Inputs:
...
plot_obj.plot_fa_rate(plot_obj.minPfa,plot_args,legend_string);
end
